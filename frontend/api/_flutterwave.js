...
export default async function handler(req, res) {
  try {
    ...
    // Always return 200 so Flutterwave stops retrying a payload we've seen.
    // The payment has been processed at this point — even if emails failed,
    // the database transaction succeeded, so returning 200 is correct.
    // Returning 500 would just cause Flutterwave to retry forever.
