  ...
  if (agent?.email) {
    await callSupabaseSendEmail({
      ...
      data: {
        ...
        agreement_fee: rentTx.agreement_fee,
        caution_fee: rentTx.caution_fee,
        inspection_fee: rentTx.inspection_fee,
        documentation_fee: rentTx.documentation_fee,
        other_fees_total: rentTx.other_fees_total,
