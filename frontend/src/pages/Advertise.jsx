...
import { advertisingAPI, AD_SLOT_SPECS, normalizeWhatsApp, safeExternalUrl, validateCreative } from '../lib/advertising';
...
export default function Advertise() {
  ...
  const total = useMemo(() => Number(selected?.price_per_day || selected?.daily_price || 0) * Number(form.durationDays), [selected, form.durationDays]);
