...
export default function Advertise() {
  ...
  const submit = async (event) => {
    ...
    try {
      ...
      const ad = await advertisingAPI.createPendingAd({ ...form, userId: user.id, durationDays: Number(form.durationDays), whatsapp: normalizeWhatsApp(form.whatsapp), destinationUrl: url, creativeUrl: uploaded.url, creativePath: uploaded.path, slotConfig: selected });
